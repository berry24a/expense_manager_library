...
# 키워드와 카테고리 정의
CATEGORIES_KEYWORDS = {
    "식비": ["육앤샤", "배달", "푸드", "식당", "마라탕", "서브웨이", "파스타", "솥밥", "우동", "일백집", "고기", "밥", "회", "술", "맥주", "소주", "일식", "중식","양식", "한식", "짜장면", "짬뽕", "치킨", "샐러드", "떡볶이", "족발", "보쌈", "두루치기", "용용선생"],
    "카페/간식": ["스타벅스", "커피", "카페", "빵집", "뚜레쥬르", "베이커리", "투썸", "메가", "쥬시", "쥬씨", "스벅","성심당", "스타벅스", "cafe", "coffee","다방"],
    "교통": ["버스", "바이크", "KTX", "지하철", "택시", "기차", "자전거", "킥보드"],
    "편의점, 마트": ["CU", "세븐일레븐", "GS25", "마트", "편의점", "이마트24", "씨유", "지에스","홈플러스","이케아","IKEA"],
    "쇼핑": ["에이블리", "쿠팡", "쇼핑", "서적", "무신사", "카카오선물하기", "지그재그", "옷", "백화점", "쇼핑", "아울렛","yes24","의류"],
    "여가": ["CGV", "영화", "노래방", "PC방", "피씨방", "피시방","PC","아이센리그","레드버튼", "여가", "시네마", "메가박스", "뮤지컬", "콘서트", "야구", "축구", "배구", "농구"]
}
